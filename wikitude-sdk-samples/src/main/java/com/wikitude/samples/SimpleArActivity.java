...
import com.wikitude.samples.advanced.NativePoiDetailExtension;
...
public class SimpleArActivity extends AppCompatActivity {
    ...
    private NativePoiDetailExtension extension;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extension = new NativePoiDetailExtension(this, architectView);
        extension.onCreate();
    }
